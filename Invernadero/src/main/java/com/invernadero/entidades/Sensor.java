package com.invernadero.entidades;
...
public class Sensor {
    ...
    public String toString() {
        return "Sensor{" + "id=" + id + ", invernaderoId=" + invernaderoId + ", humedad=" + humedad + ", humedadLimite=" + humedadLimite + ", temperatura=" + temperatura + ", temperaturaLimite=" + temperaturaLimite + ", fechaHora=" + fechaHora + '}';
    }
